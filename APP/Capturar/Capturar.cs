...
namespace APP.Capturar 
{
    /// <summary> Summary description for MainForm. </summary>
    internal class Capturar : ISampleGrabberCB, IDisposable
    {
        ...
        public Capturar(int iDeviceNum, int iWidth, int iHeight, short iBPP, Control hControl)
        {
            DsDevice[] capDevices;
